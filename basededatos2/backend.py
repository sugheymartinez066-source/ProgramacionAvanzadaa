...
class Usuario():
    lista=[]
    ruta_csv=r"c:/Users/alang/Documents/ventana/personas.csv"
    ...
    def mostrar_datos(self): #funcion
        return f"El usuario  {self.nombre} tiene {self.edad} y su pass es: {self.contra}"#f string
    ...
    def cargar_usuarios(cls):
        ...
        with open(cls.ruta_csv, "r", encoding="utf-8") as f:
            ...
            cls.lista = []
            for fila in lector:
                # Al instanciarlo, el _init_ lo agrega a la lista automáticamente
