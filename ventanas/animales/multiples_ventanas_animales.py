...
def ventana_principal():
    ...
    imagen = Image.open("C:/Users/alang/Documents/ventana/Reino Animal.jpg")
...
def ventana_elefante():
    ...
    imagen2 = Image.open ("C:/Users/alang/Documents/ventana/elefante.jpg")
...
def ventana_jirafa():
    ...
    imagen3 = Image.open ("C:/Users/alang/Documents/ventana/jirafa.jpg")
    ...
    eti3=tk.Label(ven3,text="Jirafa",bg="gray",font=("Algerian",24,"bold"))
    eti3.pack(pady=10)
    boton3=tk.Button(ven3,text="ir a ventana principal",command=lambda: regresar_a_primera(ven2) )
    boton3.pack(pady=30)
...
def ventana_castor():
    ...
    imagen4 = Image.open ("C:/Users/alang/Documents/ventana/castor.jpg")
...
def ventana_leon():
    ...
    eti5 = tk.Label (ven5, text = "Leon", bg = "gray", font = ("Algerian", 24, "bold"))
    eti5.pack(pady = 10)
    frame6=tk.Frame()
    frame6.pack(pady = 20)

    imagen5 = Image.open ("C:/Users/alang/Documents/ventana/Leon.jpg")
